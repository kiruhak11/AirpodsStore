<template>
  <div class="auth-page-pro">
    <form class="auth-form-pro" @submit.prevent="onSubmit">
      <div class="auth-form-pro__icon"><Icon icon="lucide:user" /></div>
      <h1 class="auth-form-pro__title">Вход</h1>
      ...
      <button type="submit" :disabled="auth.loading" class="auth-btn-pro"><Icon icon="lucide:log-in" /> Войти</button>
      <p class="auth-link-pro">
        Нет аккаунта?
        <NuxtLink to="/register" class="auth-link-chip-pro">Зарегистрироваться</NuxtLink>
      </p>
    </form>
  </div>
</template>
